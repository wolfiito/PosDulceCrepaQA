...
const ICON_WEBPS: Record<string, string> = {
    ...
    'coffee_hot': new URL('../assets/icons/BebidaCaliente.png', import.meta.url).href,
    ...
    'dessert': new URL('../assets/icons/Postre.png', import.meta.url).href,
    'chamoyada': new URL('../assets/icons/Chamoyada.png', import.meta.url).href,
    'fresa_crema': new URL('../assets/icons/FresaConCrema.png', import.meta.url).href,
    
    //------Configuración de iconos de bebidas calientes------//
    'item_americano': new URL('../assets/icons/Cafe_Americano.png', import.meta.url).href,
    'item_capuchino': new URL('../assets/icons/Cafe_Capuchino.png', import.meta.url).href,
    'item_tisanas': new URL('../assets/icons/Tisana.png', import.meta.url).href,
    'item_te': new URL('../assets/icons/Te.png', import.meta.url).href,
    'item_chocolate': new URL('../assets/icons/Cafe_Chocolate.png', import.meta.url).href,
    'item_chocolate_blanco': new URL('../assets/icons/Cafe_Chocolate_Blanco.png', import.meta.url).href,
    'item_vainilla_latte': new URL('../assets/icons/Vainilla_Latte.png', import.meta.url).href,
    'item_taro_latte': new URL('../assets/icons/Taro_Latte.png', import.meta.url).href,
    'item_matcha_latte': new URL('../assets/icons/Matcha_Latte.png', import.meta.url).href,
    'item_moka': new URL('../assets/icons/Cafe_Moka.png', import.meta.url).href,
    'item_latte': new URL('../assets/icons/Latte.png', import.meta.url).href,
};
